...
3. In 1-2 sentences, define end to end testing.
    ...
    We want to test a fully working application from user interface to database (or where the data is stored). We navigate to a certain URL, perform actions such as typing in text boxes and checking boxes, and test to see if the behavior is as intended.
